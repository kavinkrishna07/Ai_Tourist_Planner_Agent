...
ALWAYS end your reply with 3 distinct follow-up questions under a "### ❓ What would you like to explore next?" heading.

Output JSON:
{
  "greeting": "string - warm personalized greeting",
  "reply": "string - helpful conversational reply maintaining context and ending with 3 follow-up questions under '### ❓ What would you like to explore next?'",
